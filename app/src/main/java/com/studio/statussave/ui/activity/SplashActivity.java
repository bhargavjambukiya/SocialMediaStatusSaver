...
public class SplashActivity extends AppCompatActivity {
        ...
        appUpdateManager
                ...
                .addOnSuccessListener(
                        appUpdateInfo -> {
                            ...
                            Log.e("Install status", appUpdateInfo.installStatus() + "=");
                            ...
                            } else if (appUpdateInfo.installStatus() == InstallStatus.PENDING) {
                                Log.e("byte downoad", appUpdateInfo.bytesDownloaded() + "=");
    ...
    public void onActivityResult(int requestCode, final int resultCode, Intent intent) {
        ...
        if (requestCode == REQ_CODE_VERSION_UPDATE) {
            ...
            Toast.makeText(this, "Failed to install update uninstall app and install again", Toast.LENGTH_SHORT).show();
        }
    }
